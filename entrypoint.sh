...
wget -O rbac.yml https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/pod-delete/rbac.yaml --no-check-certificate
...
wget -O engine.yml https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/pod-delete/engine.yaml --no-check-certificate
##Changing the required fild
