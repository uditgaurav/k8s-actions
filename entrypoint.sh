...
wget -O rbac.yml https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/pod-delete/rbac.yaml --ca-directory=/etc/ssl/certs/ 
...
wget -O engine.yml https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/pod-delete/engine.yaml --ca-directory=/etc/ssl/certs/ 
##Changing the required fild
